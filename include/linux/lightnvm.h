...
typedef void (nvm_set_blk_dsecs)(int);
typedef int (nvm_set_lba_list)(int, int, void *, int);
typedef void *(nvm_get_lba_list)(int, int);
...
struct nvm_dev_ops {
	...
	nvm_erase_blk_fn	*erase_block;
        ...
        nvm_set_blk_dsecs       *set_blk_dsecs;
	nvm_set_lba_list	*set_lba_list;
	nvm_get_lba_list	*get_lba_list;
